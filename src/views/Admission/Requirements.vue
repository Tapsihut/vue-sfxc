...
const selectedStudentType = ref<'freshmen' | 'transferee' | 'cross-enrollee' | 'international'>(
    'freshmen',
)
...
const freshmenRequirements: Requirement[] = [
    ...
    { name: 'Certificate of Good Moral Character', description: 'From previous school' },
    {
        ...
        description: 'Photocopy of the Philippine Statistics Authority (PSA) Birth Certificate',
    },
    {
        name: '2x2 ID Pictures',
        description: 'Four (4) pieces of 2x2 colored picture (white background)',
    },
    { name: 'Brown Envelopes', description: 'Four (4) long brown envelopes' },
    {
        name: 'Note',
        description: 'Form 137-A will be officially requested by the Office of the Registrar.',
    },
]
...
const transfereeRequirements: Requirement[] = [
    { name: 'Certificate of Transfer Credential', description: 'Transfer credentials certificate' },
    {
        ...
        description: 'Informative Copy of Transcript of Records for Evaluation',
    },
...
const internationalRequirements: Requirement[] = [
    ...
    { name: 'Letter of Intent', description: 'Formal letter expressing intent to study' },
    {
        ...
        description: 'Authenticated by the Philippine Embassy in the country of origin',
    },
    {
        name: 'Affidavit of Support',
        description: 'By parent/guardian (authenticated at the Philippine Embassy)',
    },
    {
        name: 'Passport',
        description: 'A photocopy of a passport valid for at least six (6) months',
    },
    { name: '2x2 ID Pictures', description: 'Two (2) pieces of 2x2 colored photos' },
    {
        name: 'Application Form',
        description: 'Duly accomplished Personal History Statement or Application Form',
    },
    { name: 'Certificate of Good Moral Character', description: 'Authenticated copy' },
    {
        name: 'Medical Health Certificate',
        description: 'With chest X-ray, HIV, and Hepatitis-B results',
    },
    { name: 'Quarantine Medical Examination', description: 'Results from examination' },
    {
        name: 'English Proficiency Test',
        description: 'Non-native English speakers must pass or attend a tutorial',
    },
...
<template>
        ...
        <div class="absolute inset-0 z-10 flex flex-col justify-end pointer-events-none">
            <div class="max-w-7xl mx-auto w-full px-6 sm:px-8 lg:px-16 pb-12 md:pb-16 reveal-group">
                ...
                <p class="text-base md:text-lg text-white/60 max-w-xl leading-relaxed reveal-item">
                    Complete guide to admission requirements and enrollment process at SFXC.
                </p>
            </div>
        </div>
    </section>
    ...
    <div class="bg-background">
        <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 py-24">
            ...
            <div class="mb-16 reveal-group">
                <div class="flex items-center gap-4 mb-4 reveal-item">
                    ...
                    <span class="text-primary font-semibold text-xs uppercase tracking-[0.3em]"
                        >Admission &amp; Scholarship Office</span
                    >
                </div>
                <h2 class="text-3xl md:text-4xl font-bold text-foreground mb-6 reveal-item">
                    Admission Hub
                </h2>
                <p class="text-lg text-muted-foreground mb-6 reveal-item">
                    This Admission Hub section is your go-to place for all things related to
                    enrolling at SFXC and becoming a Xavier Knight. Run by the Admission and
                    Scholarship Office, this hub helps interested parents and students…
                </p>
                <ul
                    class="list-disc list-inside text-lg text-muted-foreground mb-8 pl-6 space-y-2 reveal-item"
                >
                    <li>
                        <router-link
                            :to="{ hash: '#courses' }"
                            class="text-tertiary hover:underline font-medium"
                            >Decide on a course;</router-link
                        >
                    </li>
                    <li>
                        <router-link
                            :to="{ hash: '#enrollment' }"
                            class="text-tertiary hover:underline font-medium"
                            >Learn how to enroll;</router-link
                        >
                    </li>
                    <li>
                        <router-link
                    ...
                    <li>
                        <router-link
                            to="/admission/tour"
                            class="text-tertiary hover:underline font-medium"
                            >Schedule a campus tour</router-link
                        >
                    </li>
                </ul>

                <h2 class="text-2xl font-bold text-foreground mb-4 reveal-item">
                    What is the Admission and Scholarship Office (ADSO)?
                </h2>
                <p class="text-lg text-muted-foreground mb-4">
                    The Admission and Scholarship Office (ADSO) is mandated to implement and oversee
                    all policies related to student admission, enrollment, and scholarship
                    administration. It ensures that enrollees are given importance. The office also
                    manages institutional, government, and private scholarship grants, ensuring
                    compliance with national regulations such as CHED-UniFAST guidelines.
                </p>
                <p class="text-lg text-muted-foreground mb-8">
                    The ADSO maintains records, processes documentation, and coordinates with
                    internal and external offices to guarantee accurate reporting and transparent
                    fund utilization.
                </p>

                <h2 class="text-2xl font-bold text-foreground mb-4 reveal-item">ADSO Objectives</h2>
                <p class="text-lg text-muted-foreground mb-4">
                    The Admission & Scholarship Office transactions are guided by the following
                    objectives:
                </p>
                <ul class="list-disc list-inside text-lg text-muted-foreground pl-6 space-y-2 mb-4">
                    <li>
                        To maintain an efficient, systematic, and transparent admission process.
                    </li>
                    <li>
                        To promote accessibility to educational opportunities through scholarships
                        and financial aid.
                    </li>
                    <li>To maintain accurate and confidential student and grantee records.</li>
                    <li>
                        To ensure compliance with institutional and national education policies.
                    </li>
                    <li>
                        To strengthen linkages with external partners for expanded scholarship
                        opportunities.
                    </li>
                    <li>
                        To cultivate a culture of excellence, accountability, and service within the
                        office and among student-grantees.
                    </li>
                </ul>

                <p class="text-lg text-muted-foreground mb-8">
                    For assistance with admission and scholarship matters, contact
                    <a
                        href="https://www.facebook.com/SFXC.ADSO"
            ...
            <div id="courses" class="mb-16 scroll-mt-24">
                <div class="mb-12 reveal-group">
                    ...
                    <p class="text-lg text-muted-foreground max-w-3xl reveal-item">
                        A Guide for Students Finding Their Path at St. Francis Xavier College
                    </p>
                </div>

                <div class="space-y-6 text-lg text-muted-foreground mb-16 reveal-group">
                    <p class="reveal-item">
                        Choosing a college course is an exciting milestone—but it can also feel
                        overwhelming. With so many options available, many students find themselves
                        asking the same question: “What course is right for me?”
                    </p>
                    <p>
                        At St. Francis Xavier College, we understand that choosing a program is not
                        just about trends or peer pressure. It’s about discovering where your
                        interests, strengths, and future goals meet. This guide is designed to help
                        you understand the programs offered at SFXC and identify which course aligns
                        best with who you are and who you want to become.
                    </p>

                    <div class="border-l-4 border-tertiary pl-6 md:pl-8 py-2 my-10 reveal-item">
                        ...
                        <ul
                            class="list-disc list-inside pl-2 space-y-3 mb-6 font-medium text-foreground"
                        >
                            <li>What subjects do you genuinely enjoy?</li>
                            <li>What skills come naturally to you?</li>
                            <li>
                                Do you see yourself teaching, managing, creating, serving, or
                                leading?
                            </li>
                            <li>
                                What kind of work environment do you imagine yourself in someday?
                            </li>
                        </ul>
                        <p class="font-bold text-primary">
                            Your answers to these questions matter. A course becomes meaningful when
                            it fits you.
                            <a
                                href="/admission/guide"
                                class="text-foreground hover:underline font-bold"
                                >Click here</a
                            >
                            to see our short quiz to help decide your preferred course.
                        </p>
                    </div>
                </div>
                ...
                <div class="mb-16 reveal-group">
                    <div class="mb-8 reveal-item">
                        <h3 class="text-xl md:text-2xl font-bold text-foreground mb-4 text-center">
                    ...
                    <template v-for="program in programs" :key="program.id">
                        <div v-show="selectedProgram === program.id" class="max-w-4xl mx-auto mt-8">
                            <div class="mb-8">
                                <h3
                                    class="text-2xl md:text-3xl font-bold text-primary leading-tight mb-2"
                                >
                                    {{ program.question }}
                                </h3>
                                <p
                                    class="text-sm md:text-base font-semibold text-tertiary uppercase tracking-widest"
                                >
                                    {{ program.collegeName }}
                                </p>
                            </div>
                            ...
                            <div class="mb-8">
                                <p
                                    class="text-sm font-semibold text-muted-foreground uppercase tracking-widest mb-4"
                                >
                                    Courses Offered
                                </p>
                                <div class="space-y-4">
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                class="shrink-0 w-6 h-6 rounded-full bg-tertiary/10 text-tertiary flex items-center justify-center text-xs font-bold mt-0.5 group-hover:bg-tertiary group-hover:text-white transition-colors"
                                            >
                                                {{ index + 1 }}
                                            </div>
                                            <div
                                                class="flex-1 min-w-0 flex items-start justify-between gap-4"
                                            >
                                                <h4
                                                    class="text-base font-semibold text-foreground leading-tight hover:text-tertiary transition-colors"
                                                >
                                                    {{ course.name }}
                                                </h4>
                                                <ChevronDown
                            ...
                            >
                                <Button
                                    variant="link"
                                    class="p-0 h-auto text-base text-primary hover:text-primary/80 font-medium transition-colors gap-2"
                                >
                                    Learn More
                                ...
                                <Button
                                    variant="ghost"
                                    size="icon"
                                    class="w-10 h-10 bg-primary/5 rounded-full text-primary hover:bg-primary hover:text-white transition-colors"
                                >
                ...
                <!-- Conclusion Box -->
                <div class="mt-24 mb-16 max-w-4xl mx-auto reveal-group">
                    <div class="mb-8 reveal-item">
                        <div class="flex items-center gap-4 mb-4">
                            <div class="w-8 h-0.5 bg-tertiary"></div>
                            <span
                                class="text-tertiary font-semibold text-xs uppercase tracking-[0.3em]"
                                >Your Path Forward</span
                            >
                        </div>
                    ...
                    <div class="space-y-6 text-lg text-muted-foreground mb-16 reveal-item">
                        <p class="leading-relaxed">
                            There is no single "best" course—only the course that best matches you.
                            At St. Francis Xavier College, we are committed to guiding you not just
                            toward a degree, but toward a purposeful future.
                        </p>
                    </div>

                    <div
                        class="flex flex-col md:flex-row gap-12 md:gap-6 items-start justify-between border-t border-border pt-12 reveal-item"
                    >
                        <div class="flex flex-col items-start w-full md:w-1/3">
                            <h4 class="text-xl font-bold text-foreground mb-2">Reflect</h4>
                            <p class="text-muted-foreground">
                                Choose a course that genuinely fits your passion and your natural
                                strengths.
                            </p>
                        </div>
                        ...
                        <div class="flex flex-col items-start w-full md:w-1/3">
                            ...
                            <p class="text-muted-foreground">
                                Choose a school that offers the environment to support your personal
                                growth.
                            </p>
                        </div>
                        ...
                        <div class="flex flex-col items-start w-full md:w-1/3">
                            ...
                            <p class="text-muted-foreground font-medium">
                                Choose St. Francis Xavier College to start building your
        ...
        <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 pb-24">
            <!-- Requirements Section -->
            <div class="mb-20">
                <div class="mb-10 reveal-group">
                    <div class="flex items-center gap-4 mb-4 reveal-item">
                        <div class="w-8 h-0.5 bg-tertiary"></div>
                        <span class="text-tertiary font-semibold text-xs uppercase tracking-[0.3em]"
                            >Enrollment Documents</span
                        >
                    </div>
                    <h2 class="text-3xl font-bold mb-3 text-foreground reveal-item">
                ...
                <div
                    class="overflow-hidden flex flex-col md:flex-row border border-border rounded-2xl shadow-sm reveal-group"
                >
                    <!-- Left Side: Student Type Selection -->
                    <div
                        class="w-full md:w-1/3 lg:w-1/4 bg-muted/30 p-4 md:p-6 border-b md:border-b-0 md:border-r border-border flex flex-row md:flex-col gap-2 md:gap-3 overflow-x-auto md:overflow-visible reveal-item"
                    >
                        <h3
                            class="text-lg font-semibold text-foreground mb-2 md:mb-4 px-2 hidden md:block"
                        >
                            Student Type
                        </h3>
                        <Button
                    ...
                    <div class="w-full md:w-2/3 lg:w-3/4 p-4 sm:p-6 md:p-8 reveal-item">
                        <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                            ...
                            >
                                <div class="flex items-start gap-4">
                                    <div
                                        class="shrink-0 w-8 h-8 rounded-full bg-tertiary/10 text-tertiary flex items-center justify-center font-bold text-sm mt-0.5"
                                    >
                                        {{ index + 1 }}
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <h4
                                            class="text-base font-bold text-foreground mb-1.5 leading-tight"
                                        >
                                            {{ req.name }}
                                        </h4>
        ...
        <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 py-24">
            ...
            <div id="enrollment" class="scroll-mt-24">
                <div class="mb-12 reveal-group">
                    ...
                    <h2 class="text-3xl font-bold mb-3 reveal-item">How to Enroll at SFXC</h2>
                    <p class="text-muted-foreground reveal-item">
                        The College implements a systematic enrollment process to ensure that all
                        students are properly registered and credited for their academic work. The
                        following steps will be followed for enrollment of new students, old
                        students, and transferee students.
                    </p>
                </div>
            ...
            <div>
                <div class="mb-12 reveal-group">
                    <div class="flex items-center gap-4 mb-4 reveal-item">
                        ...
                        <span
                            class="text-secondary font-semibold text-xs uppercase tracking-[0.3em]"
                            >FAQ</span
                        >
                    </div>
                    <h2 class="text-3xl font-bold mb-3 reveal-item">Frequently Asked Questions</h2>
                </div>

                <div class="space-y-8 reveal-group">
                    <div class="reveal-item">
                        <h3 class="text-xl font-bold text-foreground mb-2">
                            What if I late enroll in SFXC?
                        </h3>
                        <p class="text-muted-foreground mb-2">
                            Late enrollment begins on the first day of classes for returning
                            students. It includes a corresponding late enrollment fee. Enrollment
                            officially closes two (2) weeks after the start of classes (e.g., if
                            classes begin on August 12, enrollment ends on August 26).
                        </p>
                        <h4 class="font-semibold text-foreground mt-4 mb-1">New Students</h4>
                        <p class="text-muted-foreground">
                            New students who enroll a day after the official enrollment period may
                            still be accommodated without penalty, subject to approval.
                        </p>
                    </div>

                    <div class="reveal-item">
                        <h3 class="text-xl font-bold text-foreground mb-2">
                            What if I am a former student who wants to be readmitted to SFXC?
                        </h3>
                        <p class="text-muted-foreground mb-2">
                            Returning students will be readmitted under the current curriculum. The
                        ...
                        <ul class="list-disc list-inside text-muted-foreground pl-4 space-y-1">
                            ...
                            <li>
                                The Dean identifies equivalent courses from the old curriculum that
                                may be credited.
                            </li>
                            <li>
                                The student must complete all required courses under the new
                                curriculum.
                            </li>
                            <li>
                                The student must present Clearance and College Permanent Record
                                (PCR) for evaluation.
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="reveal-item">
                        ...
                        <p class="text-muted-foreground mb-2">
                            Foreign students must comply with the same basic admission requirements
                            as local students. There are different categories of Foreign Students,
                            as well as different admission requirements for Foreign Students.
                        </p>
                        <h4 class="font-semibold text-foreground mt-4 mb-1">
                            Categories of Foreign Student Applicants
                        </h4>
                        <ul class="list-disc list-inside text-muted-foreground pl-4 space-y-1">
                            <li>New Student</li>
                            ...
                            <li>
                                9A Visa Holder (Non-immigrant for pleasure, business, or health)
                            </li>
                        </ul>
                    </div>
                </div>
