...
// Define the images you want to cycle through
...
// Start rotating images on mount
onMounted(() => {
...
// Clean up timer before component is destroyed to prevent memory leaks
onUnmounted(() => {
...
const handleLogin = async () => {
  ...
  try {
    ...
    const user = mockUsers.find((u) => u.id === identifier.value && u.pass === password.value)
    ...
    >
      <div class="w-full lg:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
        <div class="w-full max-w-sm mx-auto space-y-8">
          <div class="text-center lg:text-left space-y-3">
            <div
              class="inline-flex items-center justify-center overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-slate-200"
            >
              <img
            ...
            <form @submit.prevent="handleLogin" class="space-y-4">
              ...
              <div class="space-y-1.5">
                <div class="flex items-center justify-between">
                  ...
                  <a href="#" class="text-xs font-medium text-primary hover:underline" tabindex="3"
                    >Forgot password?</a
                  >
                </div>
                <Input
              ...
              <Button
                type="submit"
                class="w-full h-12 text-base bg-[#1f8942] font-semibold transition-all hover:scale-[1.01] hover:bg-[#186d34]"
                :disabled="isLoading"
              >
      ...
      >
        <div class="absolute inset-0 z-0">
          ...
          />
          <div class="absolute inset-0 bg-gradient-to-br from-green-900/40 to-blue-900/40 z-10" />
        </div>
        ...
        <div class="relative z-20 flex flex-col h-full w-full">
          ...
          <div class="flex-1 flex flex-col justify-center">
            <h2 class="text-5xl font-black leading-tight italic">
              <span
                class="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-200"
              >
                EXCELLENCE
              </span>
              <br />IN EDUCATION
          ...
          <div class="mt-auto">
            <blockquote class="border-l-4 border-emerald-500 pl-6">
              ...
              <footer class="mt-2 text-sm font-bold text-emerald-400">— B.B. KING</footer>
            </blockquote>
          </div>
        </div>
      </div>
