...
import { programDetails, programUpdates, coordinator } from '@/data/cbeBsia'
...
<template>
    <div class="min-h-screen bg-background pb-24">
        ...
        <PageHero
            ...
            subtitle="Preparing students for careers in risk management, compliance, and corporate governance."
            subtitleMax="max-w-2xl"
        >
            <template #title>Internal Auditing</template>
        </PageHero>
        ...
        <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 py-24">
            <div class="grid lg:grid-cols-3 gap-10">
                ...
                <div class="lg:col-span-2 space-y-16">
                    <!-- Program Details Section (no intro description for BSIA) -->
                    <div class="space-y-6">
                        <div
