...
const programDetails: ProgramSection[] = [
  {
    ...
    contentBlocks: [
      ...
      { type: 'list', items: [
        ...
        'Accounting for Business Administration',
  ...
  },
  {
    ...
    contentBlocks: [
      { type: 'paragraph', content: 'BS in Business Administration opens up roles and occupation:' },
      { type: 'list', items: [
      ...
      { type: 'subtitle', content: 'WHAT INDUSTRIES WILL MOST LIKELY HIRE BS IN BUSINESS ADMINISTRATION GRADUATES?' },
      { type: 'paragraph', content: 'BS in Business Administration graduates are needed in various industries, including:' },
      { type: 'list', items: [
        'Corporate/Business',
        'Healthcare',
        'Government',
  ...
  },
  {
    ...
    contentBlocks: [
      { type: 'paragraph', content: 'To further a career in BS in Business Administration, graduates may pursue:' },
      { type: 'list', items: [
  ...
  },
  {
    ...
    contentBlocks: [
      { type: 'paragraph', content: 'To be eligible for admission in the BS in Business Administration program, applicants must meet the following requirements:' },
      { type: 'list', items: [
  ...
  {
    title: 'HOW CAN I APPLY FOR THE BACHELOR OF SCIENCE IN BUSINESS ADMINISTRATION?',
    contentBlocks: [
  ...
  {
    title: 'HOW CAN I CONTACT THE BACHELOR OF SCIENCE IN BUSINESS ADMINISTRATION PROGRAM?',
    contentBlocks: [
