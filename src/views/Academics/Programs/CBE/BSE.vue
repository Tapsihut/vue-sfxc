...
import { programDetails, programUpdates, coordinator } from '@/data/cbeBse'
...
<template>
    <div class="min-h-screen bg-background pb-24">
        ...
        <PageHero
            ...
            subtitle="Equipping students with the mindset and skills to start, manage, and grow their own ventures."
            subtitleMax="max-w-2xl"
        >
            <template #title>Entrepreneurship</template>
        </PageHero>
        ...
        <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 py-24">
            <div class="grid lg:grid-cols-3 gap-10">
                ...
                <div class="lg:col-span-2 space-y-16">
                    <!-- Program Details Section (no intro description for BSE) -->
                    <div class="space-y-6">
                        <div
                ...
                <div class="lg:col-span-1 space-y-6 lg:sticky lg:top-24 h-max">
                    <ProgramCoordinatorCard :coordinator="coordinator" />
                </div>
            </div>
