...
const programDetails: ProgramSection[] = [
  {
    title: 'WHAT SUBJECTS ARE COVERED IN BA IN ENGLISH LANGUAGE?',
    contentBlocks: [
      { type: 'paragraph', content: 'The subjects typically include:' },
      { type: 'list', items: [
        'English Language Teaching Approaches and Methods',
        'Semantics of English',
        'English Phonology and Morphology',
        'English Syntax',
        '2 foreign languages - Japanese (Nihongo) and Spanish',
        'Language of Literary Texts'
      ]}
    ]
  },
  {
    title: 'WHAT ARE THE OPPORTUNITIES AFTER COMPLETING BA IN ENGLISH LANGUAGE?',
    contentBlocks: [
      { type: 'paragraph', content: 'It opens up roles and occupation opportunities, such as:' },
      { type: 'list', items: [
        'Teaching',
        ...
        'Speech Therapy',
        'Preparatory Degree for Pursuing a Career in Law'
      ]}
    ]
  },
  {
    title: 'WHAT SKILLS CAN I EXPECT TO DEVELOP DURING BA IN ENGLISH LANGUAGE?',
    contentBlocks: [
  ...
  {
    title: 'CAN I PURSUE HIGHER STUDIES AFTER BA IN ENGLISH LANGUAGE?',
    contentBlocks: [
      { type: 'paragraph', content: 'Yes, there are several options for further studies after completing BA in English Language, such as:' },
      { type: 'list', items: [
        'MA in English Literature or Linguistics',
  ...
  {
    title: 'IS BA IN ENGLISH LANGUAGE SUITABLE FOR NON-NATIVE ENGLISH SPEAKERS?',
    contentBlocks: [
      { type: 'paragraph', content: 'Absolutely! The BA in English Language is beneficial for non-native speakers, as it enhances both language skills and understanding of English\'s structure, history, and nuances, helping students improve proficiency in all contexts.' }
    ]
  },
  {
    title: 'WHAT IS THE DIFFERENCE BETWEEN BACHELOR OF ARTS IN ENGLISH LANGUAGE AND BACHELOR OF SECONDARY EDUCATION MAJOR IN ENGLISH?',
    contentBlocks: [
  ...
  {
    title: 'CAN I PURSUE A CAREER IN WRITING AFTER COMPLETING BA IN ENGLISH LANGUAGE?',
    contentBlocks: [
      { type: 'paragraph', content: 'Definitely, the BA in English Language provides a strong foundation for a career in writing, whether as a content writer, editor, technical writer, or freelance writer. The program equips you with the necessary writing, communication, and critical thinking skills to succeed in various writing-related careers.' }
    ]
  },
  {
    title: 'DO I NEED A STRONG BACKGROUND IN ENGLISH TO PURSUE THIS PROGRAM?',
    contentBlocks: [
      { type: 'paragraph', content: 'A strong background in English is helpful, but not required. Most BA English Language programs cater to students with varying proficiency levels. What matters most is a genuine interest in the language and a desire to improve your skills in different contexts. If you\'re motivated to learn, this program is a great fit.' }
    ]
  },
  {
  ...
  {
    title: 'CAN I PURSUE THE BA IN ENGLISH LANGUAGE ONLINE AT ST. FRANCIS XAVIER COLLEGE?',
    contentBlocks: [
      { type: 'paragraph', content: 'SFXC’s BA in English Language is offered through a blended learning approach that combines face-to-face classes with online instruction. This setup allows students to gain hands-on experience, engage directly with faculty, and collaborate with peers while developing strong communication, critical thinking, and language skills.' }
    ]
  },
  {
  ...
  },
  {
    ...
    contentBlocks: [
      { type: 'paragraph', content: 'To be eligible for admission to the ABEL program, applicants must meet the following requirements:' },
      { type: 'list', items: [
  ...
  {
    title: 'HOW CAN I APPLY FOR THE ABEL PROGRAM?',
    contentBlocks: [
  ...
  {
    title: 'HOW CAN I CONTACT THE ABEL PROGRAM?',
    contentBlocks: [
      { type: 'paragraph', content: 'For inquiries regarding the Bachelor of Arts in English Language program, please contact us at abel@sfxc.edu.ph.' }
    ]
  }
]
...
const programUpdates = [
  {
    id: 1,
    title: 'English Language Week 2026',
    date: 'March 15, 2026',
    excerpt: 'Join us as we celebrate the English Language Week with poetry readings, public speaking competitions, and a keynote speech from renowned authors.',
  ...
  {
    id: 2,
    title: 'New Creative Writing Workshop Series',
    date: 'February 28, 2026',
    excerpt: 'The ABEL program is proud to announce a new partnership that integrates specialized creative writing workshops within our curriculum.',
    image: 'https://placehold.co/800x600/000000/FFFFFF?text=800x600',
  ...
  {
    id: 3,
    title: 'Alumni Spotlight: Excellence in Journalism',
    date: 'January 20, 2026',
    excerpt: 'Read about how our ABEL alumni are making their mark in the publishing and media industries across the nation.',
    image: 'https://placehold.co/800x600/000000/FFFFFF?text=800x600',
    ...
    >
      ...
      <!-- <div class="relative z-10 mt-auto w-full md:max-w-5xl ps-5 pb-16 md:ps-10 md:pb-24">
        ...
        <p class="text-white/80 mt-4 text-lg md:text-xl max-w-2xl">
          BA in English Language (ABEL) is a comprehensive undergraduate program that delves into the study of the English language, its rich literary heritage, and its cultural significance. Through this program, students explore various facets, including English grammar, linguistics, creative writing, and literary analysis. By mastering these skills, students not only enhance their ability to communicate effectively in English but also gain a deeper appreciation for the diverse world of literature.
        </p>
      </div> -->
      ...
      <div class="lg:col-span-1 space-y-6 lg:sticky lg:top-24 h-max">
        <Card class="overflow-hidden shadow-lg bg-card border-border">
          <CardHeader class="pb-4">
            ...
            <CardDescription class="text-sm font-medium">Program Head, ABEL</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card class="overflow-hidden shadow-lg bg-card border-border">
          <CardHeader class="pb-4">
            ...
            <CardDescription class="text-sm font-medium">Governor, ABEL</CardDescription>
          </CardHeader>
          <CardContent>
            <Separator class="mb-6"/>
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-3 text-sm text-card-foreground">
                <div class="flex items-start gap-3">
                  <span class="mt-0.5 font-medium text-muted-foreground">Email:</span>
                  <span>governor.abel@sfxc.edu.ph</span>
                </div>
              </div>
            </div>
          </CardContent>
